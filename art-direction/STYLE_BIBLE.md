# Joseon Hunters Style Bible v7 — H1 공통 화풍 앵커

## 공통 앵커 확정 — H1 (D-072)

PD **“이 스타일 앵커로 고정하고 pc/npc/배경등으로 확장”**. H1 승인 원본의 선·큰 형태·얼굴 표현·무광 명암을 PC·NPC·배경·소품·적에 공유한다. 인물별 승인 복식·색·소품, NPC B1/B2/B3의 역할·나이는 유지한다. 도호의 얼굴이나 의복을 모두에게 복제하지 않는다.

참조 역할: **H1 = 공통 화풍 / 각 승인 캐릭터 = 정체성 / 현재 실제 게임 = 어두운 톤·재질·크기·가독성 제약**. H1의 중립 배경 밝기를 장면 조명에 복제하지 않는다. 현재 게임의 GT1 도호나 임시 자산이 H1의 승인 외형을 덮어쓰지 않게 한다.

[확장 작업 제안](C:/workspace/joseon/docs/design/h1_style_expansion_2026-09-17.md): 기준표 → 인물 비교·마을·던전 파일럿 3장 → 실제 3D 소규모 시험 → 캐릭터 카탈로그·게임용 묶음 → 키아트/컷씬. **앵커만 확정이며 제작 순서·물량은 제안**, 신규 이미지·GLB의 일괄 채택이 아니다.
